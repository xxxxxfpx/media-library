> 原文链接: [https://docs.flutter.dev/deployment/linux](https://docs.flutter.dev/deployment/linux)
---
...
During a typical development cycle,
                  ...
                  or by using the**Run**and**Debug**options in your IDE. By default,
                  Flutter builds a*debug*version of your app.

`flutter run`
When you're ready to prepare a*release*version of your app,
                  for example to[publish to the Snap Store](https://snapcraft.io/store)or an[alternative channel](#additional-deployment-resources),
                  this page can help.
...
The`snapcraft`tool builds snaps based on the instructions
                  ...
                  core concepts, take a look at the[Snap documentation](https://snapcraft.io/docs)and the[Introduction to snapcraft](https://snapcraft.io/blog/introduction-to-snapcraft).
...
The[DBus interface](https://snapcraft.io/docs/dbus-interface)provides a way for snaps to
...
`<project root>/snap/gui/super-cool-app.desktop`
...
`<project root>/snap/gui/super-cool-app.png`
## Build the snap
...
1. Create a developer account at[snapcraft.io](https://snapcraft.io/), if you
                    haven't already done so.
1. Register the app's name. Registration can be done
                    either using the Snap Store Web UI portal, or from the
                    command line, as follows:@copy_button data={"buttonText":null,"classes":[],"title":"Copy code to clipboard"}/@copy_button
1. Release the app. After reading the next section
                    to learn about selecting a Snap Store channel,
                    push the snap to the store:@copy_button data={"buttonText":null,"classes":[],"title":"Copy code to clipboard"}/@copy_button
...
Defines the readiness of the application.
                      The risk levels used in the snap store are:`stable`,`candidate`,`beta`, and`edge`.
...
Unless stated otherwise, the documentation on this site reflects Flutter 3.41.5. Page last updated on 2026-05-05.[View source](https://github.com/flutter/website/blob/main/sites/docs/src/content/deployment/linux.md)or[report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/deployment/linux&page-source=https://github.com/flutter/website/blob/main/sites/docs/src/content/deployment/linux.md).
