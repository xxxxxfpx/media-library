> 原文链接: [https://docs.flutter.dev/tools/devtools/cli](https://docs.flutter.dev/tools/devtools/cli)
---
...
To upgrade DevTools, upgrade Flutter.
                  ...
                  If`which dart`points to a Dart SDK*not*included in your Flutter SDK, updating that
