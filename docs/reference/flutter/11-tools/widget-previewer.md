> 原文链接: [https://docs.flutter.dev/tools/widget-previewer](https://docs.flutter.dev/tools/widget-previewer)
---
...
![Flutter Widget Previewer in Android Studio](https://docs.flutter.dev/assets/images/docs/tools/widget-previewer/android-studio.png)
...
![Flutter Widget Previewer in Visual Studio Code](https://docs.flutter.dev/assets/images/docs/tools/widget-previewer/vscode.png)
...
After you've started the previewer, to look at a widget,
                  you must use the[@Preview](https://api.flutter.dev/flutter/widget_previews/Preview-class.html)annotation defined in`package:flutter/widget_previews.dart`. This annotation
                  can be applied to:

`@Preview`
`package:flutter/widget_previews.dart`
- **Top-level functions**that return a`Widget`or`WidgetBuilder`.
- **Static methods**within a class that return a`Widget`or`WidgetBuilder`.
...
![Sample widget in Flutter Widget Previewer](https://docs.flutter.dev/assets/images/docs/tools/widget-previewer/widget-previewer.png)Each preview instance provides various controls for
...
**Perform a hot restart for the individual preview:**Restarts only the specific widget preview,
...
![Filter by previews selected file in Flutter Widget Previewer](https://docs.flutter.dev/assets/images/docs/tools/widget-previewer/filter-by-file.gif)
...
The[@Preview](https://api.flutter.dev/flutter/widget_previews/Preview-class.html)annotation has several parameters you can
...
`group`
**size**: Artificial size constraints using a`Size`object.
...
**wrapper**: A function that wraps your previewed
                      ...
                      application state into the widget tree with an`InheritedWidget`).
...
To reduce the amount of boilerplate needed to define previews with
                  a common set of properties, the[Preview](https://api.flutter.dev/flutter/widget_previews/Preview-class.html)annotation class can be
...
Extending the[Preview](https://api.flutter.dev/flutter/widget_previews/Preview-class.html)annotation class also allows for overriding
                  the[Preview.transform()](https://api.flutter.dev/flutter/widget_previews/Preview/transform.html)method. This method is invoked by the widget previewer
...
Creating multiple previews with different configurations can be as
                  simple as applying multiple[@Preview](https://api.flutter.dev/flutter/widget_previews/Preview-class.html)annotations to a single
...
![Multiple previews in Flutter Widget Previewer](https://docs.flutter.dev/assets/images/docs/tools/widget-previewer/multi-preview.png)

To simplify creating multiple previews with common configurations, you
                  can extend the[MultiPreview](https://api.flutter.dev/flutter/widget_previews/MultiPreview-class.html)to create a custom annotation that creates
                  multiple previews. The following[MultiPreview](https://api.flutter.dev/flutter/widget_previews/MultiPreview-class.html)creates
...
Widget buttonPreview() => const ButtonShowcase();`
Like[Preview](https://api.flutter.dev/flutter/widget_previews/Preview-class.html),[MultiPreview](https://api.flutter.dev/flutter/widget_previews/MultiPreview-class.html)also provides a[MultiPreview.transform()](https://api.flutter.dev/flutter/widget_previews/MultiPreview/transform.html)method to perform transformations
...
`dart:io`
`dart:ffi`
See the[Dart documentation on conditional imports](https://dart.dev/tools/pub/create-packages#conditionally-importing-and-exporting-library-files)for details
                      on how to structure your application to cleanly support
                      platform-specific libraries when targeting multiple platforms.

**Asset paths**: When using`fromAsset`APIs from`dart:ui`to load resources, you must use**package-based paths**instead of direct local paths.
                      This ensures that the assets can be correctly located
                      and loaded within the previewer's web environment. For
                      example, use`'packages/my_package_name/assets/my_image.png'`instead of`'assets/my_image.png'`.
...
**Multi-project support in IDEs**: The widget previewer
                      ...
                      Flutter projects ([#173550](https://github.com/flutter/flutter/issues/173550)).

Unless stated otherwise, the documentation on this site reflects Flutter 3.41.5. Page last updated on 2026-05-05.[View source](https://github.com/flutter/website/blob/main/sites/docs/src/content/tools/widget-previewer.md)or[report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&page-url=https://docs.flutter.dev/tools/widget-previewer&page-source=https://github.com/flutter/website/blob/main/sites/docs/src/content/tools/widget-previewer.md).
