> 原文链接: [https://docs.flutter.dev/platform-integration/android/compose-activity](https://docs.flutter.dev/platform-integration/android/compose-activity)
---
...
Adding this functionality requires making several changes to
                  ...
                  On the Android side, you will need to register a matching native`MethodChannel`to receive the signal from Dart and then launch a new activity.
...
1. The method name (in this sample, the value is`"launchActivity"`).
1. The structure of the data which Dart passes and
...
1. android/app/build.gradle.ktskotlin@copy_button data={"buttonText":null,"classes":[],"title":"Copy code to clipboard"}/@copy_buttonandroid/app/build.gradlegroovy@copy_button data={"buttonText":null,"classes":[],"title":"Copy code to clipboard"}/@copy_button
1. android/build.gradle.ktskotlin@copy_button data={"buttonText":null,"classes":[],"title":"Copy code to clipboard"}/@copy_buttonandroid/build.gradlegroovy@copy_button data={"buttonText":null,"classes":[],"title":"Copy code to clipboard"}/@copy_button
1. android/app/src/main/AndroidManifest.xmlxml@copy_button data={"buttonText":null,"classes":[],"title":"Copy code to clipboard"}/@copy_button
1. MainActivity.ktkotlin@copy_button data={"buttonText":null,"classes":[],"title":"Copy code to clipboard"}/@copy_button
1. MainActivity.ktkotlin@copy_button data={"buttonText":null,"classes":[],"title":"Copy code to clipboard"}/@copy_button
1. MainActivity.ktkotlin@copy_button data={"buttonText":null,"classes":[],"title":"Copy code to clipboard"}/@copy_button

Add the following to the existing`android`block:

`android`
- [Kotlin](#182-tab-panel)
- [Groovy](#183-tab-panel)
...
Visit the[developer.android.com](https://developer.android.com/jetpack/androidx/releases/compose-kotlin)link in the code snippet and
...
`flutter run`
Next, add the following block at the bottom of the file, at the root level:
...
Add the following buildscript block at the top of the file:
...
In the root application block, add the following`<activity>`declaration:
...
The fourth and final code requiring modifications is`android/app/src/main/kotlin/com/example/flutter_android_activity/MainActivity.kt`.
...
Add a second`Activity`to the bottom of the file, which you
